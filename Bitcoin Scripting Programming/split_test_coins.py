...
if __name__ == '__main__':
    ...
    private_key = CBitcoinSecret('cP2jUgShzKb5nVuduRYGtNtzZ3NQhAHvJcNnGRSbbZpBirUYpjW3')
    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.01001297  # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        'ecf272a35ae048c7ad9db25a4d2bc15c97beae8b9d971c92f26cdb004eccb91f')
